...
To add add additional properties, use the `add()` method on the vcard.
...
The third argument of the add() method allows you to specify any additional
parameters.
